...
class DeepSpeechSeqPipeline:
    def __init__(self, profile, language, model, lm=None, beam_width=500, max_candidates=None,
        ...
        self.rnn_stage = RnnSeqPipelineStage(profile, language, model, device=device)

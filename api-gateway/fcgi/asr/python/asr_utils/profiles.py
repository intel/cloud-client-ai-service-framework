...
PROFILES = {
    'mds06x_en': {
        ...
        #'alphabet': '/home/wx/work/cfoc/open_model_zoo/demos/speech_recognition_deepspeech_demo/python/models/vacab.txt',
...
PROFILES['mds09x_ch'] = PROFILES['mds09x_en'].copy()
PROFILES['mds09x_ch'].update({
    #'alphabet': '/home/wx/work/cfoc/open_model_zoo/demos/speech_recognition_deepspeech_demo/python/models/vocab.txt',
    'alphabet': list(""),
    'alpha': 0.6940122363709647,
    'beta': 4.777924224113021,
    #'frame_window_size_seconds': 16e-3,
        # frame_stride_seconds (float, in seconds)
    #'frame_stride_seconds': 10e-3,
})

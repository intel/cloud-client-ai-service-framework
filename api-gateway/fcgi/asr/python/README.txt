...
This service has two modes:
 ...
 -  Notice
    ...
    An audio file should be PCM WAV 16 kHz mono format.

An example code for the client side, please refer to post_local_asr_py.py 
...
The VAD part is based on https://github.com/wiseman/py-webrtcvad.

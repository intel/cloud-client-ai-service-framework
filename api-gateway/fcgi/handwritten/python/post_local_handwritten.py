...
def main(args):
    ...
    url= 'http://localhost:8080/cgi-bin/fcgi_py_handwritten'
...
if __name__ == "__main__":
    ...
    parser.add_argument("-i", "--image", default = "./input_data/handwritten_simplified_chinese_test.png", help = "the path of the picture")

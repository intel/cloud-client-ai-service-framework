...
mo --input_model ./det.onnx --output_dir . --data_type FP32 --input_shape [1,3,640,640] --mean_values [123.675,116.28,103.53] --scale_values [58.395,57.12,57.375]
...
do
    ...
    mo --input_model ./rec.onnx --output_dir . --data_type FP32 --input_shape [1,3,32,$width] --static_shape --mean_values [123.675,116.28,103.53] --scale_values [58.395,57.12,57.375]

...
class infer_onnx_entity : public IInfer_entity {
  public:
    infer_onnx_entity();
    ~infer_onnx_entity();
    ...
    virtual int video_infer_init(struct modelParams& modelFile, const std::string& device, struct mock_data& IOInformation) override;
